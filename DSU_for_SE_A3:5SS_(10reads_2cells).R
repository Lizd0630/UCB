...
#### **** DSU10 **** ####
## all reads must more than 10 and appear at least in 2 cells
#### 0. basic settings ---------------------------------------------------------------------------------------------------------------------------
require(parallel)
library(dplyr)
library(plyr)
...
save(psi.co, file = paste(pfro,"DSU10_2cells_psi.co_20180228.RData",sep = ""))

pdf(paste(pffo, "PSI_distribution_2cells.pdf", sep = ""))
...
pdf(paste(pffo, "SE/SE_PSI_distribution_2cells.pdf", sep = ""))
## density plot
...
pdf(paste(pffo,"SE/PSI_distribution_of_SE_type_2cells.pdf", sep = ""))
par(mar = c(2,12,2,12))
...
save(SE_type, SE_GTF, file = paste(pffo, "SE/RData/SE_DSU_10reads_2cells_result_20180228.RData", sep = ""))
...
save(A3SS, A3SS_psi, A3SS_type, A3SS_GTF, file = paste(pffo, "A3SS/RData/A3SS_DSU_10reads_2cells_result_20180228.RData", sep = ""))
...
save(A5SS, A5SS_psi, A5SS_type, A5SS_GTF, file = paste(pffo, "A5SS/RData/A5SS_DSU_10reads_2cells_result_20180228.RData", sep = ""))
...
save(MXE,MXE_type, file = paste(pffo, "MXE/RData/MXE_DSU_10reads_2cells_result_20171228.RData", sep = ""))
