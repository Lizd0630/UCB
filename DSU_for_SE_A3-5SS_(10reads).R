...
save(SE_type, SE_GTF, file = paste(pffo, "SE/RData/SE_DSU_10reads_result_20180228.RData", sep = ""))
...
save(A5SS, A5SS_psi, A5SS_type, A5SS_GTF, file = paste(pffo, "A5SS/RData/A5SS_DSU_10reads_result_20180228.RData", sep = ""))
...
save(MXE,MXE_type, file = paste(pffo, "MXE/RData/MXE_DSU_result_20171226.RData", sep = ""))
